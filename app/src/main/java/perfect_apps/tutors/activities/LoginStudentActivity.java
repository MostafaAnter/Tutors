    ...
    private void parseFeed(String strJson) {
        ...
        if (jsonRootObject.optInt("status_code") == 200){
            try {
                ...
                new TutorsPrefStore(LoginStudentActivity.this).addPreference(Constants.USER_ID, id);
                new TutorsPrefStore(LoginStudentActivity.this).addPreference(Constants.USER_IMAGE_FULL_PATH, image_full_path);
